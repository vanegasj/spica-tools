...
class Topdat:
    def __init__(self):
        ...
        self.atomname, self.atomtype, self.segid, self.resname, self.resid = [], [], [], [], []
    ...
    for idx in range(sysdat.ntops):
        with open(f"toppar/{topdat[idx].fname}.itp", "w") as fout:
            ...
            for jdx in range(topdat[idx].nat):
                print("{:6d} {:>6s} {:6d} {:>6s} {:>6s} {:6d} {:8.4f}".format(
                       jdx+1, 
                       topdat[idx].atomtype[jdx],
                       topdat[idx].resid[jdx],
            ...
            for jdx in range(topdat[idx].nmol):
                ...
                for kdx in range(topdat[idx].nat):
                    ...
                    print("{:8} {:<4}{:5} {:<4} {:<4} {:<4}  {:9.6f}  {:12.4f}".format(
                           ...
                           atidx, topdat[idx].resname[kdx], min(9999,topdat[idx].resid[kdx]), 
        ...
        while line:
            ...
            if items[0] == "atom":
                try:
                    ...
                    if len(items) > 8:
                        topdat[ntop].resid.append(int(items[8]))
                    else:
                        topdat[ntop].resid.append(1)
                except:
